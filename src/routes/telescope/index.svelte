<script>
  ...
  const sampleSeeds = [
    'Qmbp5ae9UdBjDPR1H66rA5q4Dj7n6rcwCdVFurTrWr8w1s',
    'Qmbp5ae9UdBjDPR1H66rA5q4Dj7n6rcwCdVFurTrWr8w1s',
    'Qmbp5ae9UdBjDPR1H66rA5q4Dj7n6rcwCdVFurTrWr8w1s',
  ]
</script>
...
<h2>Search</h2>
<p>
To use the telescope, type the Constellation's Seed (CID) in the navbar above.
</p>
<br>
...
<ul>
{#each sampleSeeds as constellation}
  <li>
    <a href="/telescope/{constellation}">{constellation}</a>
  </li>
{/each}
</ul>
